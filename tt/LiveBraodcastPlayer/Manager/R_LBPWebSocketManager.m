//
//  R_LBPWebSocketManager.m
//  tt
//
//  Created by l on 2021/2/25.
//

#import "R_LBPWebSocketManager.h"
#import "AFNetworkReachabilityManager.h"

@interface R_LBPWebSocketManager ()<SRWebSocketDelegate>
...
static R_LBPWebSocketManager *manager = nil;

@implementation R_LBPWebSocketManager
...
+ (instancetype)shareInstance{
    ...
    dispatch_once(&onceToken, ^{
        manager = [[R_LBPWebSocketManager alloc]init];
    });
    return manager;
}
